      ...
      <div className="w-full h-full flex items-center justify-between m-auto px-[10px]">
        ...
        >
          <Image
            ...
            width={50}
            height={50}
            className="w-[50px] h-auto md:w-[55px] md:h-auto transition-transform duration-300 ease-in-out hover:scale-110 cursor-pointer"
          />
        </div>
        ...
        <div className="hidden md:flex flex-row gap-5">
          ...
          <motion.div
            onClick={() => scrollToSection("#tokenomics", 100)}
            className="z-[1] bg-transparent cursor-pointer bg-black hover:bg-[#2E2E2E] rounded-xl text-white py-2 px-5 text-lg"
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.95 }}
          >
          ...
          <motion.div
            onClick={() => scrollToSection("#roadmap", 100)}
            className="z-[1] bg-transparent cursor-pointer bg-black hover:bg-[#2E2E2E] rounded-xl text-white py-2 px-5 text-lg"
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.95 }}
          >
        ...
        {isOpen && (
          <div className="absolute top-[65px] left-0 w-full bg-black flex flex-col items-center gap-5 py-5 md:hidden">
            ...
            <motion.div
              onClick={() => scrollToSection("#howtobuy", 100)}
              className="z-[1] bg-transparent cursor-pointer text-white py-2 px-5 text-base"
              whileHover={{ scale: 1.1 }}
              whileTap={{ scale: 0.95 }}
            >
