  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h1>Market Cap</h1>
          <h2 className="text-xl md:text-2xl font-bold">$6.35K</h2>
        </motion.div>
        <motion.div
          className="p-4 bg-gradient-to-r from-gray-800 via-gray-900 to-black rounded-lg shadow-lg"
          variants={fadeInUp}
        >
          ...
          <h1>Current Price</h1>
          <h2 className="text-xl md:text-2xl font-bold">$0.0₅6349</h2>
        </motion.div>
        <motion.div
          className="p-4 bg-gradient-to-r from-gray-800 via-gray-900 to-black rounded-lg shadow-lg"
          variants={fadeInUp}
        >
          ...
          <h1>Holders</h1>
          <h2 className="text-xl md:text-2xl font-bold">22</h2>
        </motion.div>
      </motion.div>
